...
##### Reference: https://stackoverflow.com/questions/7048839/sql-server-query-to-find-all-permissions-access-for-all-users-in-a-database
##### For Azure SQL DB change "login_token" to "user_token"
```
/*
